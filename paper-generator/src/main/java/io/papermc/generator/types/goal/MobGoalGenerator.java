...
public class MobGoalGenerator extends SimpleGenerator {
    ...
    protected TypeSpec getTypeSpec() {
        ...
        Stream<GoalKey> vanillaGoals = classes.stream()
            ...
            .sorted(Comparator.<GoalKey, String>comparing(o -> o.entityClassName().simpleName())
        ...
        vanillaGoals.forEach(goalKey -> {
            ...
            TypeName typedKey = ParameterizedTypeName.get(Types.GOAL_KEY, goalKey.entityClassName());
            FieldSpec.Builder fieldBuilder = FieldSpec.builder(typedKey, fieldName, PUBLIC, STATIC, FINAL)
                .initializer("$N($S, $T.class)", createMethod.build(), keyPath, goalKey.entityClassName());
