...
@NullMarked
public abstract class OverriddenUnsafeClassGenerator extends SimpleGenerator {
    ...
    protected OverriddenUnsafeClassGenerator(ClassNamed baseClass, String className, String packageName) {
    ...
    public MethodSpec.Builder createUnsafeMethod(String name, TypeName... parameterTypes) {
        MethodSpec.Builder methodBuilder = MethodSpec.methodBuilder(name)
            .addModifiers(PUBLIC)
