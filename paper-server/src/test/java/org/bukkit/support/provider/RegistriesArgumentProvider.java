...
public class RegistriesArgumentProvider implements ArgumentsProvider {
    ...
    static {
        ...
        register(RegistryKey.DATA_COMPONENT_TYPE, DataComponentType.class, Registries.DATA_COMPONENT_TYPE, PaperDataComponentType.class, net.minecraft.core.component.DataComponentType.class);
